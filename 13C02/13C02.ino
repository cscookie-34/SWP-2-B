...
#define _DUTY_NEU 750 // servo neutral position (90 degree)
#define _DUTY_MAX 1000 // servo full counter-clockwise position (180 degree)

#define _POS_START 500  // servo start position
#define _POS_END   1000   // servo end position
//180도 1초 회전인 경우 위 코드를 수정, 500, 1500 2500, 그리고 pos start는 +100, end는 -100
...
void setup() {
  ...
  duty_change_per_interval = 
    (float)(_DUTY_MAX - _DUTY_MIN) * (_SERVO_SPEED / 90.0) * (INTERVAL / 1000.0);
    //180도 1초 회전인 경우네는 90.0 을 180.0으로 수정 
  ...
  //180도 1초 회전인 경우에는 90.0을 180.0으로 수정 
